...
bucket <- paste0("neon4cast-drivers/noaa/gefs-v12/stage2/parquet/0/", noaa_date) 
...
noaa_future_daily %>% ungroup() %>% distinct(parameter)
```
...
# suppresses dplyr's summarise message
